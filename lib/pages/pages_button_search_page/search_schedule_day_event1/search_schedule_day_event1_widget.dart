...
import 'search_schedule_day_event1_model.dart';
export 'search_schedule_day_event1_model.dart';

class SearchScheduleDayEvent1Widget extends StatefulWidget {
  const SearchScheduleDayEvent1Widget({super.key});

  @override
  State<SearchScheduleDayEvent1Widget> createState() =>
      _SearchScheduleDayEvent1WidgetState();
}

class _SearchScheduleDayEvent1WidgetState
    extends State<SearchScheduleDayEvent1Widget> with TickerProviderStateMixin {
  late SearchScheduleDayEvent1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SearchScheduleDayEvent1Model());
