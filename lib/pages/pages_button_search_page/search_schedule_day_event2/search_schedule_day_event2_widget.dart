...
import 'search_schedule_day_event2_model.dart';
export 'search_schedule_day_event2_model.dart';

class SearchScheduleDayEvent2Widget extends StatefulWidget {
  const SearchScheduleDayEvent2Widget({super.key});

  @override
  State<SearchScheduleDayEvent2Widget> createState() =>
      _SearchScheduleDayEvent2WidgetState();
}

class _SearchScheduleDayEvent2WidgetState
    extends State<SearchScheduleDayEvent2Widget> with TickerProviderStateMixin {
  late SearchScheduleDayEvent2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SearchScheduleDayEvent2Model());
                ...
                Padding(
                  ...
                  child: FlutterFlowChoiceChips(
                    options: const [
                      ...
                      ChipData('Programação Cultural', Icons.music_note_sharp),
                      ChipData(
