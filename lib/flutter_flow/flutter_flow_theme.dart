...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF585DF9);
  late Color secondary = const Color(0xFF39D2C0);
  late Color tertiary = const Color(0xFFF9C24B);
  late Color alternate = const Color(0xFFE0E3E7);
  late Color primaryText = const Color(0xFF14181B);
  late Color secondaryText = const Color(0xFFB2E5F5);
  late Color primaryBackground = const Color(0xFFF1F4F8);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0xFF00C133);
  late Color accent2 = const Color(0x4D00FFDC);
  late Color accent3 = const Color(0x4DEE8B60);
  late Color accent4 = const Color(0xFFB5B6CF);
  late Color success = const Color(0xFF249689);
  late Color warning = const Color(0xFFF9CF58);
  late Color error = const Color(0xFFBC1623);
  late Color info = const Color(0xFFFFFFFF);

  late Color corPrimariaSuave = const Color(0xFF3970D2);
}
